...
export default async function Hero({ locale, strings }: { locale: string; strings: HeroStrings }) {
  ...
  return (
    <section className="relative min-h-[60vh] md:min-h-[80vh] flex items-center justify-center overflow-hidden pt-[112px] md:pt-[230px] pb-[40px] md:pb-[92px]" style={{ background: '#1C122C' }}>
