...
export default function TestimonialsCarousel({ testimonials, locale, strings }: Props) {
  ...
  return (
    <section className="py-[4rem] md:py-[9.1rem] bg-cream bg-subtle-pattern">
      <div className="container mx-auto px-4 lg:px-8 max-w-3xl text-center">
        <RichText html={strings.subtitle} as="p" className="text-gold text-[12px] uppercase tracking-[0.3em] mb-4" />
        <RichText html={strings.title} as="h2" className="font-heading text-2xl md:text-4xl text-dark mb-10 md:mb-20 gold-underline inline-block" />
