        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-8 max-w-[120rem] mx-auto">
          {services.map((service, i) => {
            ...
            <ScrollReveal key={service.id} delay={i * 150} className={colClass}>
              <div className="relative h-full p-8 bg-white border border-gray-100 group hover:scale-[1.15] hover:shadow-lg" style={{ transition: 'transform 0.7s, box-shadow 0.7s' }}>
                {/* Roman numeral */}
