...
const TYPO_GROUPS = [
  ...
  { key: 'serviceTitle', label: 'Service Titles', defaultSize: '1.46', defaultColor: '#1C122C', defaultFont: 'heading' },
  { key: 'serviceBody', label: 'Service Description', defaultSize: '1.3', defaultColor: '#5a5a6e', defaultFont: 'body' },
