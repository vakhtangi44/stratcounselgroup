...
export default function AdvantagesReorderList({ initialItems }: { initialItems: Advantage[] }) {
  ...
  async function saveOrder() {
    setSaving(true)
    await fetch('/api/admin/advantages/reorder', {
      method: 'PUT',
          ...
          <tbody className="divide-y divide-gray-100">
            {items.map((item, i) => (
              ...
              >
                ...
                <td className="px-4 py-3">
                  <Link href={`/admin/advantages/${item.id}/edit`} className="text-gold hover:underline">
                    Edit
                  </Link>
                </td>
              </tr>
