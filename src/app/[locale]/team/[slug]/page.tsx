      ...
      <section className="bg-section-gradient text-white py-20 px-4">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="flex flex-col md:flex-row gap-10 items-start">
            <div className="relative w-56 h-56 md:w-64 md:h-64 rounded-sm overflow-hidden shrink-0 border-2 border-gold/20 shadow-2xl" style={{ background: 'var(--color-header, var(--color-dark))' }}>
              {member.photo && (
                <Image
                  src={member.photo}
