            ...
            <div className="bg-white p-10 md:p-14 text-navy">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 border border-[#668CCE]/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-4 h-4 text-[#668CCE]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                ...
                {/* Phone */}
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 border border-[#668CCE]/30 flex items-center justify-center flex-shrink-0">
                    <svg className="w-4 h-4 text-[#668CCE]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                ...
                <div className="flex items-center gap-3">
                  {strings.facebook && (
                    <a
                      ...
                      rel="noopener noreferrer"
                      aria-label="Facebook"
                      className="w-10 h-10 border border-[#668CCE]/30 flex items-center justify-center text-[#668CCE] hover:bg-[#668CCE] hover:text-white transition-all duration-300"
                    >
              ...
              {status === 'success' ? (
                <div className="text-center py-20 bg-white border border-gray-100">
                  <div className="w-16 h-16 mx-auto mb-6 border border-gold/20 flex items-center justify-center">
                    <svg className="w-8 h-8 text-[#668CCE]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
