...
export default async function LocaleLayout({
  ...
  const telegram = s(settings, 'contact.telegram', locale)
  const facebook = s(settings, 'contact.facebook', locale)
  const linkedin = s(settings, 'contact.linkedin', locale)
  ...
  const typoGroups = ['heroTitle', 'heroTagline', 'sectionTitle', 'sectionTitleDark', 'subtitle', 'cardTitle', 'cardBody', 'body', 'serviceTitle', 'serviceBody', 'button', 'teamBio', 'footerHeading', 'footerBody']
  ...
  return (
    <NextIntlClientProvider messages={messages}>
      ...
      {/* Floating contact buttons: WhatsApp, Telegram, Facebook, LinkedIn */}
      <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-50">
        ...
        {facebook && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-[#1877F2] text-white w-12 h-12 rounded-full flex items-center justify-center shadow-lg hover:bg-[#0e5fc9] transition-colors"
            aria-label="Facebook"
          >
            <svg width="22" height="22" fill="currentColor" viewBox="0 0 24 24">
        ...
        {linkedin && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-[#0A66C2] text-white w-12 h-12 rounded-full flex items-center justify-center shadow-lg hover:bg-[#084c91] transition-colors"
            aria-label="LinkedIn"
          >
            <svg width="22" height="22" fill="currentColor" viewBox="0 0 24 24">
